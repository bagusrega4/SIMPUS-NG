...
export default function Login() {
  ...
  const TEST_CREDENTIALS = [
    ...
    {
      email: "erna@stis.ac.id",
      password: "ernadosen123",
    },
  ];
    ...
    setTimeout(() => {
      ...
      if (validCredential) {
        ...
        if (email === "erna@stis.ac.id") {
          userName = "Erna Nurmawti";
        } else if (email === "222212455@stis.ac.id") {
          userName = "Agape Bagus Rega Anggara";
        }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stis-blue-light via-white to-stis-gray-light flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-stis-blue to-stis-cyan hover:from-stis-blue-dark hover:to-stis-blue text-white font-medium py-3 px-4 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl"
            >
              {isLoading ? (
